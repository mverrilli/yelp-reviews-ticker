...
* Small bug fixes
* More code markups
* Code compliance (according to codex) check
* Now displays errors (due to wrong phone number or API Key being incorrect)
* Better handling of instances

= 2.0 =
* Fixed issues with API (went from v2 back to v1)
